...
?><!doctype html><html lang="pt-BR"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Login | Espaço Aura</title><link rel="icon" type="image/png" sizes="512x512" href="img/favicon-aura.png"><link rel="shortcut icon" href="img/favicon.ico"><link rel="stylesheet" href="css/style.css"></head><body><header class="header"><div class="container nav"><a href="index.php" class="brand"><img src="img/logo-aura-oficial.png" alt="Espaço Aura"></a><a href="index.php" class="back-link">← Voltar</a></div></header><main class="form-page"><div class="form-container"><p class="eyebrow">PORTAL DA EQUIPE</p><h1>Acesso ao sistema</h1><?php mostrarFlash(); if($erro):?><div class="alert error" data-popup="1"><?=htmlspecialchars($erro)?></div><?php endif;?><form method="post" class="form-card"><label>E-mail</label><input type="email" name="email" autocomplete="username" required><label>Senha</label><input type="password" name="senha" autocomplete="current-password" required><button class="btn btn-full">Entrar</button><p style="text-align:center;margin:14px 0 0"><a href="esqueci-senha.php">Esqueceu sua senha?</a></p></form></div></main><script src="js/app.js"></script></body></html>
